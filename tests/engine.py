...
class ExecutionEngine(hitchtest.ExecutionEngine):
    ...
    def set_up(self):
        ...
        postgres_user = hitchpostgres.PostgresUser("unusualbusiness", "password")

        self.services['Postgres'] = hitchpostgres.PostgresService(
            postgres_package=postgres_package,
            users=[postgres_user, ],
            databases=[hitchpostgres.PostgresDatabase("unusualbusiness", postgres_user), ]
        )
        ...
        self.services['Celery'] = hitchpython.CeleryService(
            python=python_package.python,
            app="unusualbusiness.taskapp", loglevel="INFO",
            needs=[
