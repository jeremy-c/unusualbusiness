    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('search_description_en', models.TextField(blank=True, null=True, verbose_name='search description')),
                ('search_description_nl', models.TextField(blank=True, null=True, verbose_name='search description')),
                ('format', models.CharField(choices=[(b'text', 'Normal Article'), (b'theory', 'Theory Article'), (b'video', 'Video embed'), ((b'audio',), 'Audio embed'), (b'images', 'Image slideshow'), (b'event', 'Event'), (b'organization', 'Organization'), (b'link', 'External Link'), (b'document', 'Document Download')], default=b'event', max_length=32, verbose_name='page_format')),
                ...
                ('poster_link', models.URLField(blank=True, verbose_name='Poster')),
                ('flyer_link', models.URLField(blank=True, verbose_name='Flyer')),
