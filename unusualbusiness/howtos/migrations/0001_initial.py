    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('search_description_nl', models.TextField(blank=True, null=True, verbose_name='search description')),
                ('search_description_en', models.TextField(blank=True, null=True, verbose_name='search description')),
                ('description', wagtail.wagtailcore.fields.RichTextField(blank=True, null=True, verbose_name='Description')),
                ('description_nl', wagtail.wagtailcore.fields.RichTextField(blank=True, null=True, verbose_name='Description')),
                ('description_en', wagtail.wagtailcore.fields.RichTextField(blank=True, null=True, verbose_name='Description')),
            ],
            options={
                'verbose_name': 'Knowledge pool',
                'verbose_name_plural': 'Knowledge pools',
            },
            bases=('wagtailcore.page',),
        ),
        migrations.CreateModel(
