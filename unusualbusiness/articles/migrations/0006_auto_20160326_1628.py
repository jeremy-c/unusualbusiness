...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('articles', '0005_auto_20160326_1539'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='body',
            field=wagtail.wagtailcore.fields.StreamField([('paragraph', wagtail.wagtailcore.blocks.RichTextBlock()), ('image', wagtail.wagtailimages.blocks.ImageChooserBlock()), ('pullquote', wagtail.wagtailcore.blocks.StructBlock([(b'text', wagtail.wagtailcore.blocks.CharBlock(required=True))])), ('carousel', wagtail.wagtailcore.blocks.StreamBlock([(b'image', wagtail.wagtailimages.blocks.ImageChooserBlock()), (b'embed', wagtail.wagtailembeds.blocks.EmbedBlock())]))]),
        ),
        migrations.AlterField(
            model_name='reportarticlepage',
            name='body_en',
