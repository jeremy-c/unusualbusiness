...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('articles', '0007_auto_20160330_1545'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.SET_NULL, verbose_name='photo', blank=True, to='wagtailimages.Image', null=True)),
            ],
            options={
                'abstract': False,
            },
